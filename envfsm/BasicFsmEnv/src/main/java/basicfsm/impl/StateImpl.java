 ...
 * </p>
 * <ul>
 *   <li>{@link basicfsm.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link basicfsm.impl.StateImpl#getIn <em>In</em>}</li>
 *   <li>{@link basicfsm.impl.StateImpl#getOut <em>Out</em>}</li>
 *   <li>{@link basicfsm.impl.StateImpl#getDecls <em>Decls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	protected EClass eStaticClass() {
		return BasicfsmPackage.Literals.STATE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicfsmPackage.STATE__NAME, oldName, name));
	}
	...
	public EList<Trans> getIn() {
		if (in == null) {
			in = new EObjectWithInverseResolvingEList<Trans>(Trans.class, this, BasicfsmPackage.STATE__IN, BasicfsmPackage.TRANS__TGT);
		}
		return in;
	}
	...
	public EList<Trans> getOut() {
		if (out == null) {
			out = new EObjectWithInverseResolvingEList<Trans>(Trans.class, this, BasicfsmPackage.STATE__OUT, BasicfsmPackage.TRANS__SRC);
		}
		return out;
	}
	...
	public EList<VarDecl> getDecls() {
		if (decls == null) {
			decls = new EObjectContainmentEList<VarDecl>(VarDecl.class, this, BasicfsmPackage.STATE__DECLS);
		}
		return decls;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BasicfsmPackage.STATE__DECLS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasicfsmPackage.STATE__NAME:
				return getName();
			case BasicfsmPackage.STATE__IN:
				return getIn();
			case BasicfsmPackage.STATE__OUT:
