...
/**
 * This is the item provider adapter for a {@link simpleal.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplealPackage.Literals.BLOCK__STMTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Block.class)) {
			case SimplealPackage.BLOCK__STMTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplealPackage.Literals.BLOCK__STMTS,
				 SimplealFactory.eINSTANCE.createPrint()));

		newChildDescriptors.add
			(createChildParameter
				(SimplealPackage.Literals.BLOCK__STMTS,
				 SimplealFactory.eINSTANCE.createAssign()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return SimpleALEditPlugin.INSTANCE;
	}
