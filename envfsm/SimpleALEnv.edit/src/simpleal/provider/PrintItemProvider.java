...
/**
 * This is the item provider adapter for a {@link simpleal.Print} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrintItemProvider extends StmtItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Print_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Print_name_feature", "_UI_Print_type"),
				 SimplealPackage.Literals.PRINT__NAME,
				 true,
				 false,
				 false,
