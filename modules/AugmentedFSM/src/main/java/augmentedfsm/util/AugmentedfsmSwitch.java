 ...
 * @generated
 */
public class AugmentedfsmSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static AugmentedfsmPackage modelPackage;
	 ...
	 * @generated
	 */
	public AugmentedfsmSwitch() {
		if (modelPackage == null) {
			modelPackage = AugmentedfsmPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AugmentedfsmPackage.EXECUTABLE_STATE: {
			...
			case AugmentedfsmPackage.GUARDED_TRANSITION: {
