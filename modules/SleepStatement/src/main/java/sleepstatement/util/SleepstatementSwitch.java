 ...
 * @generated
 */
public class SleepstatementSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SleepstatementPackage modelPackage;
	 ...
	 * @generated
	 */
	public SleepstatementSwitch() {
		if (modelPackage == null) {
			modelPackage = SleepstatementPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SleepstatementPackage.SLEEP: {
