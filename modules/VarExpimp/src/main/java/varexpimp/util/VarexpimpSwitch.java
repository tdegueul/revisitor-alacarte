 ...
 * <!-- end-user-doc -->
 * @see varexpimp.VarexpimpPackage
 * @generated
 */
public class VarexpimpSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static VarexpimpPackage modelPackage;
	 ...
	 * @generated
	 */
	public VarexpimpSwitch() {
		if (modelPackage == null) {
			modelPackage = VarexpimpPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VarexpimpPackage.VAR_DECL: {
			...
			case VarexpimpPackage.VAR_REF: {
				VarRef varRef = (VarRef)theEObject;
				T result = caseVarRef(varRef);
				if (result == null) result = caseLit(varRef);
